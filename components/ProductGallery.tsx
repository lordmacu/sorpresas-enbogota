...
export function ProductGallery({ imagen, galeria = [], alt, children }: ProductGalleryProps) {
  ...
  if (imagenes.length === 0) {
    return (
      <div className="relative aspect-[4/5] rounded-3xl bg-[#F5E6D3]/30 overflow-hidden flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative aspect-[4/5] rounded-3xl bg-[#F5E6D3]/30 overflow-hidden ring-gold">
        <Image
          src={activa}
          alt={alt}
          fill
